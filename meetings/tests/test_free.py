...
#commented out tests were having strange errors, not related to project function. something about "indeces can't be strings"
...
# 	#november 23rd to 25th, a 3 day range with start and end times 5:45 AM to 11:45PM
# 	free_time = {'start': '2017-11-23T05:45:00-08:00', 'end': '2017-11-23T23:45:00-08:00'}
# 	#because freetimes only calls a single block, I must define multiple to test
# 	free_time2 = {'start': '2017-11-24T05:45:00-08:00', 'end': '2017-11-24T23:45:00-08:00'}

# 	#3 days each with an event, so there should be 2 free times per day for 6 total
# 	busy_time = [{'start': '2017-11-23T08:30:00-8:00', 'end': '2017-11-23T13:25:00-08:00', 'sum': 'test event'}, {'start': '2017-11-24T15:45:00-8:00', 'end': '2017-11-24T17:10:00-08:00', 'sum': 'test event 2'}]

# 	result1 = freetimes(free_time, busy_time)
# 	result2 = freetimes(free_time2, busy_time)
